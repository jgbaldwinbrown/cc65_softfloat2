...
*----------------------------------------------------------------------------*/
float32 int32_to_float32( long );
void int32_to_float64( float64 *dst, long );

/*----------------------------------------------------------------------------
| Software IEEE single-precision conversion routines.
*----------------------------------------------------------------------------*/
long float32_to_int32( float32 );
long float32_to_int32_round_to_zero( float32 );
void float32_to_float64( float64 *dst, float32 );
...
*----------------------------------------------------------------------------*/
long float64_to_int32( float64 *src );
long float64_to_int32_round_to_zero( float64 *src );
float32 float64_to_float32( float64 *src );

/*----------------------------------------------------------------------------
| Software IEEE double-precision operations.
*----------------------------------------------------------------------------*/
void float64_round_to_int( float64 *dst, float64 *src );
void float64_add( float64 *dst, float64 *x, float64 *y );
void float64_sub( float64 *dst, float64 *x, float64 *y );
void float64_mul( float64 *dst, float64 *x, float64 *y );
void float64_div( float64 *dst, float64 *x, float64 *y );
void float64_rem( float64 *dst, float64 *x, float64 *y );
void float64_sqrt( float64 *dst, float64 *src );
